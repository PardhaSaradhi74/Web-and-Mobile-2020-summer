        ...
        tts = new TextToSpeech(getApplicationContext(), new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if(status != TextToSpeech.ERROR) {
                    ...
                    mVoiceInputTv.setText(Html.fromHtml("<p style=\"color:green;\">Speaker : Hello !!</p>"));
                }
            }
        });
            ...
            case REQ_CODE_SPEECH_INPUT: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    if(result != null && result.size() > 0) {
                        mVoiceInputTv.append(Html.fromHtml("<p style=\"color:red;\">User : "+result.get(0)+"</p>"));
                        ...
                        if(result.get(0).equalsIgnoreCase("hello")) {
                            ...
                            mVoiceInputTv.append(Html.fromHtml("<p style=\"color:green;\">Speaker : What is your name ?</p>"));
                            ...
                            mVoiceInputTv.append(Html.fromHtml("<p style=\"color:green;\">Speaker : Hello, "+name+"</p>"));
                        }else if(result.get(0).contains("not feeling good")){
                            tts.speak("I can understand. Please tell your symptoms in short",
                                    TextToSpeech.QUEUE_FLUSH, null);
                            mVoiceInputTv.append(Html.fromHtml("<p style=\"color:green;\">Speaker : I can understand. Please tell your symptoms in short</p>"));
                            ...
                            mVoiceInputTv.append(Html.fromHtml("<p style=\"color:green;\">Speaker : Thank you too, "+preferences.getString("name","")+" Take care.</p>"));
                            ...
                            mVoiceInputTv.append(Html.fromHtml("<p style=\"color:green;\">Speaker : The time is : "+sdfDate.format(now)+"</p>"));
                        }else if(result.get(0).contains("medicine")){
                            tts.speak("I think you have fever. Please take this medicine.",
                                    TextToSpeech.QUEUE_FLUSH, null);
                            mVoiceInputTv.append(Html.fromHtml("<p style=\"color:green;\">Speaker : I think you have fever. Please take this medicine.</p>"));
                        } else {
                            tts.speak("Sorry, I cant help you with that", TextToSpeech.QUEUE_FLUSH, null);
                            mVoiceInputTv.append(Html.fromHtml("<p style=\"color:green;\">Speaker : Sorry, I cant help you with that</p>"));
                        }
                    }
                }
                break;
