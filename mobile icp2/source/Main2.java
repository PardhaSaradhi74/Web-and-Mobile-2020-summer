...
public class Main2 extends AppCompatActivity {
    ...
    CheckBox chicken, pepperoni, onion;
    ...
    private String fetchDetails() {
        ...
        total_price = calculate_price(chicken_flag, pepperoni_flag, onion_flag, quantity);

        return fetchOrderSummary(customer_name.getText().toString(), chicken_flag, pepperoni_flag, onion_flag, small_flag,medium_flag,large_flag, total_price);
    }
    ...
    private String fetchOrderSummary(String userName, boolean chicken_flag, boolean pepperoni_flag,
                                     boolean onion_flag ,boolean small_flag,boolean medium_flag, boolean large_flag, float total_price) {
    ...
    private float calculate_price(boolean chicken, boolean pepperoni, boolean onion, Integer quantity) {
